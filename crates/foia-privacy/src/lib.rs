...
//! - `FOIA_DIRECT=1` - Disable Tor entirely
//! - `FOIA_NO_OBFUSCATION=1` - Use Tor without pluggable transports
...
pub use config::{
    display_security_warning, socks_proxy_from_env, HiddenServiceConfig, HiddenServiceProvider,
    HiddenServiceSecurityLevel, PrivacyConfig, PrivacyMode, SecurityLevel, SourcePrivacyConfig,
    Transport,
};
