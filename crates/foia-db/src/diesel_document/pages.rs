...
use foia_models::{DocumentPage, PageOcrStatus};
use crate::models::{DocumentPageRecord, PageOcrResultRecord};
...
impl DieselDocumentRepository {
    ...
    pub async fn save_page(&self, page: &DocumentPage) -> Result<i64, DieselError> {
        ...
        use crate::sea_tables::DocumentPages;
    ...
    pub async fn store_page_ocr_result(
        ...
        use crate::pool::build_sql;
        use crate::sea_tables::PageOcrResults;
    ...
    pub async fn store_pdftotext_results_batch(
        ...
        use crate::sea_tables::{DocumentPages, PageOcrResults};
    ...
    pub async fn search_page_content(
        ...
        use crate::sea_tables::{DocumentPages, Documents, DocumentVersions};
        use sea_query::{Alias, Expr, Query};
...
mod tests {
    use super::*;
    use foia_models::{Document, DocumentStatus, DocumentVersion, PageOcrStatus};
    use crate::diesel_document::tests::setup_test_db;
    use crate::diesel_document::DieselDocumentRepository;
    use chrono::Utc;
